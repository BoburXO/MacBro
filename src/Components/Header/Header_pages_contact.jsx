                ...
                <div className="container">
                    <div className="header__block">
                        ...
                        <div className="right">
                            ...
                            <p><i className='fa-solid fa-phone'></i> +998787772020</p>
                            <p><i className='fa-solid fa-envelope'></i> macbroofficial@gmail.com</p>
                            <p><i className='fa-solid fa-location-dot'></i> г. Ташкент, ул Паркентская, 219</p>
                            <p><i className='fa-solid fa-location-dot'></i> Г. Ташкент, Шайхонтахурский р-н, ул. Алишера Навои 27</p>
                            <p><i className='fa-solid fa-location-dot'></i> Г. Ташкент, Мирзо-Улугбекский р-н, Узбекистан овози, 21</p>
                            <b>
